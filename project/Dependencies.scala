...
object Dependencies {
  ...
  val caseApp = "com.github.alexarchambault" %% "case-app" % "2.1.0-M6"
  val catsEffect = "org.typelevel" %% "cats-effect" % "3.2.2"
  ...
  val fs2Core = "co.fs2" %% "fs2-core" % "3.1.0"
  val fs2Io = "co.fs2" %% "fs2-io" % fs2Core.revision
  val http4sCore = "org.http4s" %% "http4s-core" % "1.0.0-M24"
